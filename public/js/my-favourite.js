    ...
    function printProduct(data) {
        ...
        $.each(data, function( index, value ) {
            content+=
                ...
                '               <div class="card">\n' +
            '                  <button type="button" item=' + value.product.id + ' class="btn '+ ((value.product.is_saved == null) ? 'btn-danger' : 'btn-primary')+' btn-lg float-right button-save saved" >' + ((value.product.is_saved == null) ? 'UnSaved' : 'Saved') +'</button>\n' +
