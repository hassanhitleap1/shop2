...
<div class="container">
   <div class="row" id="products">
      ...
      <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 pb-2" id="{{$savedProduct->product->id}}">
         <div class="card">
            <button type="button"  item="{{$savedProduct->product->id}}" class="btn btn-danger  float-right button-save saved" > <span class="fas fa-trash-alt fa-btn-save"></span>{{__('lang.Un_Saved')}}</button>
            ...
            <div class="card-footer">
               ...
               <a href="{{$savedProduct->product->link}}" class="btn btn-primary btn-sm float-right " target="_blank" >{{__('lang.Check_Out')}}</a>
            </div>
         </div>
      </div>
      @endforeach
