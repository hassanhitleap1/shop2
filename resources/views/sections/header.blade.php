<div class="container">
      <div class="pb-2 mt-4 mb-2 border-bottom">
         <div class="row justify-content-md-center">
            ...
            <div class="col-md-auto">
               <img src="{{asset('logo-1.png')}}" class="rounded mx-auto d-block" >
            </div>
            <div class="col col-lg-4">
   ...
   <?php 
   $sliders= \App\Slider::where('published',\App\Slider::Published);
   $count=$sliders->count();
   ?>
   <!-- bigian slider -->
   @if($count)
                 ...
                 <?php $i=0; ?> 
                  @foreach ($sliders as $slider)
                        <div class="carousel-item {{$i==0?'active':''}}">
                              <img class="d-block w-100" src="{{asset($slider->image_path)}}" alt="{{++$i}}">
                        </div>
                  @endforeach
            </div>
