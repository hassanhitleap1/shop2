...
<div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 pb-2" id="{{$product->id}}">
                <div class="card">
                   <button type="button"  item="{{$product->id}}" class="btn {{($product->isSaved != null)?'btn-primary':'btn-danger'}}  btn-lg float-right button-save saved" >{{($product->isSaved != null)?'UnSave':'Saved'}}</button>
